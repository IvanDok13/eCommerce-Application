...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    imageUrl:
      'https://www.ricktamlyn.com/wp-content/uploads/offtheshelf_exports/coffee-landing-page-6355/placeholder-coffee.jpg',
    categories: ['Realism'],
    description: 'A realistic rose with fine details and soft gradients.',
  },
  ...
  // Graphics and illustration
  {
    ...
    imageUrl:
      'https://www.ricktamlyn.com/wp-content/uploads/offtheshelf_exports/coffee-landing-page-6355/placeholder-coffee.jpg',
    categories: ['Graphics and illustration'],
